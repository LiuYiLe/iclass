if (function(e, t) {
    ...
    function u(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (r = "data-" + t.replace(xt, "-$1").toLowerCase(), n = e.getAttribute(r), "string" == typeof n) {
                try {
    ...
    function x(e) {
        var t = J, n = Mt[e];
        return n || (n = b(e, t), "none" !== n && n || (Pt = (Pt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Pt[0].contentDocument, t.write(), t.close(), n = b(e, t), Pt.detach()), Mt[e] = n), n
    }
    function w(e, t, n) {
        var r, i, o, a, s = e.style;
        return n = n || Bt(e), n && (a = n.getPropertyValue(t) || n[t]), n && ("" !== a || Z.contains(e.ownerDocument, e) || (a = Z.style(e, t)), Wt.test(a) && It.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    function T(e, t) {
        return {
            get: function() {
    ...
    function E(e, t, n) {
        var r=!0, i = "width" === t ? e.offsetWidth : e.offsetHeight, o = Bt(e), a = "border-box" === Z.css(e, "boxSizing", !1, o);
        if (0 >= i || null == i) {
            if (i = w(e, t, o), (0 > i || null == i) && (i = e.style[t]), Wt.test(i))
                return i;
    ...
    function j(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
            r = e[a], r.style && (o[a] = vt.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ct(r) && (o[a] = vt.access(r, "olddisplay", x(r.nodeName)))) : (i = Ct(r), "none" === n && i || vt.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
        for (a = 0; s > a; a++)
    ...
    function L(e, t, n) {
        var r, i, o, a, s, u, l, c, f = this, d = {}, p = e.style, h = e.nodeType && Ct(e), m = vt.get(e, "fxshow");
        ...
        if (Z.isEmptyObject(d))
            "inline" === ("none" === l ? x(e.nodeName) : l) && (p.display = l);
        else {
            ...
            for (r in d)
                a = q(h ? m[r] : 0, r, f), r in m || (m[r] = a.start, h && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    function F(e, t) {
        var n, r, i, o, a;
    ...
    function $(e, t, n) {
        var r, i, o = 0, a = tn.length, s = Z.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = Gt || D(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++)
                l.tweens[a].run(o);
        ...
        for (F(c, l.opts.specialEasing);
        a > o;
        o++)if (r = tn[o].call(l, e, c, l.opts))
            return r;
    ...
    function M(e, t, n, r) {
        ...
        if (Z.isArray(t))
            Z.each(t, function(t, i) {
                n || Sn.test(e) ? r(e, i) : M(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
            });
    ...
    var W = [], B = W.slice, z = W.concat, X = W.push, U = W.indexOf, Q = {}, V = Q.toString, Y = Q.hasOwnProperty, G = {}, J = e.document, K = "2.1.3", Z = function(e, t) {
    ...
    var it = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : M) !== L && q(t), t = t || L, n = n || [], s = t.nodeType, "string" != typeof e ||!e || 1 !== s && 9 !== s && 11 !== s)
                return n;
            if (!r && $) {
                if (11 !== s && (i = yt.exec(e)))
                    if (a = i[1]) {
                        if (9 === s) {
                            if (o = t.getElementById(a), !o ||!o.parentNode)
                                ...
                                if (o.id === a)
                                    return n.push(o), n
                        } else if (t.ownerDocument && (o = t.ownerDocument.getElementById(a)) && _(t, o) && o.id === a)
                            return n.push(o), n
                    } else {
                        if (i[2])
                ...
                if (w.qsa && (!H ||!H.test(e))) {
                    if (p = f = P, h = t, m = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (l = S(e), (f = t.getAttribute("id")) ? p = f.replace(xt, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", u = l.length; u--;)
                            l[u] = p + d(l[u]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (u = t[P] || (t[P] = {}), (s = u[r]) && s[0] === I && s[1] === o)
                                return l[2] = s[2];
        ...
        function v(e, t, n, i, o, a) {
            return i&&!i[P] && (i = v(i)), o&&!o[P] && (o = v(o, a)), r(function(r, a, s, u) {
                var l, c, f, d = [], p = [], h = a.length, v = r || m(t || "*", s.nodeType ? [s] : s, []), y=!e ||!r && t ? v : g(v, d, e, s, u), b = n ? o || (r ? e : h || i) ? [] : a : y;
                if (n && n(y, b, s, u), i)
                    for (l = g(b, p), i(l, [], s, u), c = l.length; c--;)(f = l[c])
                        && (b[p[c]]=!(y[p[c]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
                            for (l = [], c = b.length; c--;)(f = b[c])
                                && l.push(y[c] = f);
                            o(null, b = [], l, u)
                        }
                        for (c = b.length; c--;)(f = b[c])
                            && (l = o ? et(r, f) : d[c])>-1 && (r[l]=!(a[l] = f))
                        }
                } else
                    b = g(b === a ? b.splice(h, b.length) : b), o ? o(null, a, b, u) : K.apply(a, b)
            })
        }
        function y(e) {
        ...
        function b(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function(r, a, s, u, l) {
                var c, f, d, p = 0, h = "0", m = r && [], v = [], y = N, b = r || o && T.find.TAG("*", l), x = I += null == y ? 1: Math.random() || .1, w = b.length;
        ...
        var x, w, T, C, k, S, E, j, N, D, A, q, L, F, $, H, O, R, _, P = "sizzle" + 1 * new Date, M = e.document, I = 0, W = 0, B = n(), z = n(), X = n(), U = function(e, t) {
            return e === t && (A=!0), 0
        }, Q = 1<<31, V = {}.hasOwnProperty, Y = [], G = Y.pop, J = Y.push, K = Y.push, Z = Y.slice, et = function(e, t) {
            for (var n = 0, r = e.length; r > n; n++)
                if (e[n] === t)
                    return n;
            return - 1
        }, tt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", rt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", it = rt.replace("w", "w#"), ot = "\\[" + nt + "*(" + rt + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + it + "))|)" + nt + "*\\]", at = ":(" + rt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", st = new RegExp(nt + "+", "g"), ut = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$", "g"), lt = new RegExp("^" + nt + "*," + nt + "*"), ct = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ft = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]", "g"), dt = new RegExp(at), pt = new RegExp("^" + it + "$"), ht = {
            ID: new RegExp("^#(" + rt + ")"),
            CLASS: new RegExp("^\\.(" + rt + ")"),
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, F = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), $=!k(r), w.attributes = i(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = i(function(e) {
                return e.appendChild(r.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = vt.test(r.getElementsByClassName), w.getById = i(function(e) {
                return F.appendChild(e).id = P, !r.getElementsByName ||!r.getElementsByName(P).length
            ...
            })), (w.matchesSelector = vt.test(R = F.matches || F.webkitMatchesSelector || F.mozMatchesSelector || F.oMatchesSelector || F.msMatchesSelector)) && i(function(e) {
                w.disconnectedMatch = R.call(e, "div"), R.call(e, "[s!='']:x"), O.push("!=", at)
            }), H = H.length && new RegExp(H.join("|")), O = O.length && new RegExp(O.join("|")), t = vt.test(F.compareDocumentPosition), _ = t || vt.test(F.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n ||!w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === M && _(M, e)?-1 : t === r || t.ownerDocument === M && _(M, t) ? 1 : D ? et(D, e) - et(D, t) : 0 : 4 & n?-1 : 1)
            } : function(e, t) {
                if (e === t)
                    return A=!0, 0;
                var n, i = 0, o = e.parentNode, s = t.parentNode, u = [e], l = [t];
                if (!o ||!s)
                    return e === r?-1 : t === r ? 1 : o?-1 : s ? 1 : D ? et(D, e) - et(D, t) : 0;
                if (o === s)
                    return a(e, t);
            ...
            if ((e.ownerDocument || e) !== L && q(e), n = n.replace(ft, "='$1']"), !(!w.matchesSelector ||!$ || O && O.test(n) || H && H.test(n)))
                try {
                    var r = R.call(e, n);
            ...
            var n = T.attrHandle[t.toLowerCase()], r = n && V.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !$): void 0;
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild: g.lastChild], a && y) {
                                for (c = g[P] || (g[P] = {}), l = c[e] || [], p = l[0] === I && l[1], d = l[0] === I && l[2], f = p && g.childNodes[p]; f=++p && f && f[m] || (d = p = 0)
                                    || h.pop();
                                )if (1 === f.nodeType&&++d && f === t) {
                                    c[e] = [I, p, d];
                                    break
                                }
                            } else if (y && (l = (t[P] || (t[P] = {}))[e]) && l[0] === I)
                                d = l[1];
                            else
                                for (; (f=++p && f && f[m] || (d = p = 0) || h.pop())
                                    && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType)||!++d || (y && ((f[P] || (f[P] = {}))[e] = [I, d]), f !== t));
                            );
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, S = t.tokenize = function(e, n) {
            ...
            for (s = e, u = [], l = T.preFilter; s;) {
                ...
                for (a in T.filter)
                    !(i = ht[a].exec(s)) || l[a]&&!(i = l[a](i)) || (r = i.shift(), o.push({
                        value: r,
                        type: a,
                        matches: i
                    }), s = s.slice(r.length));
            ...
            var i, o, a, s, u, l = "function" == typeof e && e, f=!r && S(e = l.selector || e);
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && $ && T.relative[o[1].type]) {
            ...
            return (l || E(e, f))(r, t, !$, n, bt.test(e) && c(t.parentNode) || t), n
        }, w.sortStable = P.split("").sort(U).join("") === P, w.detectDuplicates=!!A, q(), w.sortDetached = i(function(e) {
    ...
    Z.Callbacks = function(e) {
        ...
        when: function(e) {
            var t, n, r, i = 0, o = B.call(arguments), a = o.length, s = 1 !== a || e && Z.isFunction(e.promise) ? a: 0, u = 1 === s ? e: Z.Deferred(), l = function(e, n, r) {
                return function(i) {
    ...
    var Et = /^key/, jt = /^(?:mouse|pointer|contextmenu)|click/, Nt = /^(?:focusinfocus|focusoutblur)$/, Dt = /^([^.]*)(?:\.(.+)|)$/;
    Z.event = {
        global: {},
        add: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, d, p, h, m, g = vt.get(e);
            if (g)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = Z.guid++), (u = g.events) || (u = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
                    ...
                    s = Dt.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p && (f = Z.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = Z.event.special[p] || {}, c = Z.extend({
                        type: p,
                        origType: m,
                        data: r,
                        handler: n,
        ...
        remove: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, d, p, h, m, g = vt.hasData(e) && vt.get(e);
            if (g && (u = g.events)) {
                for (t = (t || "").match(pt) || [""], l = t.length; l--;)
                    if (s = Dt.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (f = Z.event.special[p] || {}, p = (r ? f.delegateType : f.bindType) || p, d = u[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;)
        ...
        trigger: function(t, n, r, i) {
            var o, a, s, u, l, c, f, d = [r || J], p = Y.call(t, "type") ? t.type: t, h = Y.call(t, "namespace") ? t.namespace.split("."): [];
            if (a = s = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType&&!Nt.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, t = t[Z.expando] ? t : new Z.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[p] || {}, i ||!f.trigger || f.trigger.apply(r, n)!==!1)
                ) {
                ...
                for (o = 0; (a = d[o++])&&!t.isPropagationStopped();)
                    t.type = o > 1 ? u : f.bindType || p, c = (vt.get(a, "events") || {})[t.type] && vt.get(a, "handle"), c && c.apply(a, n), c = l && a[l], c && c.apply && Z.acceptData(a) && (t.result = c.apply(a, n), t.result===!1 && t.preventDefault());
        ...
        dispatch: function(e) {
            e = Z.event.fix(e);
            var t, n, r, i, o, a = [], s = B.call(arguments), u = (vt.get(this, "events") || {})[e.type] || [], l = Z.event.special[e.type] || {};
            if (s[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e)!==!1) {
                for (a = Z.event.handlers.call(this, e, u), t = 0; (i = a[t++])&&!e.isPropagationStopped();)
                    for (e.currentTarget = i.elem, n = 0; (o = i.handlers[n++])&&!e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(o.namespace)
                        ) && (e.handleObj = o, e.data = o.data, r = ((Z.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s), void 0 !== r && (e.result = r)===!1 && (e.preventDefault(), e.stopPropagation()));
        ...
        fix: function(e) {
            ...
            for (a || (this.fixHooks[i] = a = jt.test(i) ? this.mouseHooks : Et.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new Z.Event(o), t = r.length; t--;)
                n = r[t], e[n] = o[n];
    ...
    var At = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, qt = /<([\w:]+)/, Lt = /<|&#?\w+;/, Ft = /<(?:script|style|link)/i, $t = /checked\s*(?:[^=]|=\s*.checked.)/i, Ht = /^$|\/(?:java|ecma)script/i, Ot = /^true\/(.*)/, Rt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, _t = {
    ...
    _t.optgroup = _t.option, _t.tbody = _t.tfoot = _t.colgroup = _t.caption = _t.thead, _t.th = _t.td, Z.extend({
            ...
            for (var i, o, a, s, u, l, c = t.createDocumentFragment(), f = [], d = 0, p = e.length; p > d; d++)
                if (i = e[d], i || 0 === i)
                    if ("object" === Z.type(i))
                        ...
                        for (o = o || c.appendChild(t.createElement("div")), a = (qt.exec(i) || ["", ""])[1].toLowerCase(), s = _t[a] || _t._default, o.innerHTML = s[1] + i.replace(At, "<$1></$2>") + s[2], l = s[0]; l--;)
                            o = o.lastChild;
        ...
        html: function(e) {
            return gt(this, function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e&&!Ft.test(e)&&!_t[(qt.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(At, "<$1></$2>");
                    try {
                        for (; r > n; n++)
        ...
        domManip: function(e, t) {
            e = z.apply([], e);
            var n, r, i, o, a, s, u = 0, l = this.length, c = this, f = l - 1, d = e[0], m = Z.isFunction(d);
            if (m || l > 1 && "string" == typeof d&&!G.checkClone && $t.test(d))
            ...
            if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                for (i = Z.map(v(n, "script"), p), o = i.length; l > u; u++)
                    a = n, u !== f && (a = Z.clone(a, !0, !0), o && Z.merge(i, v(a, "script"))), t.call(this[u], a, u);
                if (o)
    ...
    var Pt, Mt = {}, It = /^margin/, Wt = new RegExp("^(" + wt + ")(?!px)[a-z%]+$", "i"), Bt = function(t) {
    ...
    var zt = /^(none|table(?!-c[ea]).+)/, Xt = new RegExp("^(" + wt + ")(.*)$", "i"), Ut = new RegExp("^([+-])=(" + wt + ")", "i"), Qt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Vt = {
    ...
    Z.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = Z.cssProps[s] || (Z.cssProps[s] = C(u, s)), a = Z.cssHooks[t] || Z.cssHooks[s], void 0 === n ? a && "get"in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Ut.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[s] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set"in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n)), void 0)
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = Z.camelCase(t);
            return t = Z.cssProps[s] || (Z.cssProps[s] = C(e.style, s)), a = Z.cssHooks[t] || Z.cssHooks[s], a && "get"in a && (i = a.get(e, !0, n)), void 0 === i && (i = w(e, t, r)), "normal" === i && t in Vt && (i = Vt[t]), "" === n || n ? (o = parseFloat(i), n===!0 || Z.isNumeric(o) ? o || 0 : i) : i
        }
    ...
    var Gt, Jt, Kt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + wt + ")([a-z%]*)$", "i"), en = /queueHooks$/, tn = [L], nn = {
        "*": [function(e, t) {
    ...
    Z.Animation = Z.extend($, {
    ...
    }(); var rn, on, an = Z.expr.attrHandle; Z.fn.extend({
        attr : function(e, t) {
        ...
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === St ? Z.prop(e, t, n) : (1 === o && Z.isXMLDoc(e) || (t = t.toLowerCase(), r = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? on : rn)), void 0 === n ? r && "get"in r && null !== (i = r.get(e, t)) ? i : (i = Z.find.attr(e, t), null == i ? void 0 : i) : null !== n ? r && "set"in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void Z.removeAttr(e, t))
        },
    ...
    Z.fn.extend({
        ...
        prop: function(e, t, n) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a)
                return o = 1 !== a ||!Z.isXMLDoc(e), o && (t = Z.propFix[t] || t, i = Z.propHooks[t]), void 0 !== n ? i && "set"in i && void 0 !== (r = i.set(e, n, t)) ? r : e[t] = n : i && "get"in i && null !== (r = i.get(e, t)) ? r : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    Z.fn.extend({
        val: function(e) {
            var t, n, r, i = this[0];
            {
                ...
                if (i)
                    return t = Z.valHooks[i.type] || Z.valHooks[i.nodeName.toLowerCase()], t && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(ln, "") : null == n ? "" : n)
            }
        }
    }), Z.extend({
        valHooks: {
    ...
    var dn = /#.*$/, pn = /([?&])_=[^&]*/, hn = /^(.*?):[ \t]*([^\r\n]*)$/gm, mn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, gn = /^(?:GET|HEAD)$/, vn = /^\/\//, yn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, bn = {}, xn = {}, wn = "*/".concat("*"), Tn = e.location.href, Cn = yn.exec(Tn.toLowerCase()) || [];
    Z.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function(e, t) {
            function n(e, t, n, a) {
                var u, c, v, y, x, T = t;
                2 !== b && (b = 2, s && clearTimeout(s), r = void 0, o = a || "", w.readyState = e > 0 ? 4 : 0, u = e >= 200 && 300 > e || 304 === e, n && (y = _(f, w, n)), y = P(f, y, w, u), u ? (f.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (Z.lastModified[i] = x), x = w.getResponseHeader("etag"), x && (Z.etag[i] = x)), 204 === e || "HEAD" === f.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, c = y.data, v = y.error, u=!v)) : (v = T, (e ||!T) && (T = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || T) + "", u ? h.resolveWith(d, [c, T, w]) : h.rejectWith(d, [w, T, v]), w.statusCode(g), g = void 0, l && p.trigger(u ? "ajaxSuccess" : "ajaxError", [w, f, u ? c: v]), m.fireWith(d, [w, T]), l && (p.trigger("ajaxComplete", [w, f]), --Z.active || Z.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (t = e, e = void 0), t = t || {};
            var r, i, o, a, s, u, l, c, f = Z.ajaxSetup({}, t), d = f.context || f, p = f.context && (d.nodeType || d.jquery) ? Z(d): Z.event, h = Z.Deferred(), m = Z.Callbacks("once memory"), g = f.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                readyState: 0,
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || Tn) + "").replace(dn, "").replace(vn, Cn[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(pt) || [""], null == f.crossDomain && (u = yn.exec(f.url.toLowerCase()), f.crossDomain=!(!u || u[1] === Cn[1] && u[2] === Cn[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Cn[3] || ("http:" === Cn[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), O(bn, f, t, w), 2 === b)
                return w;
    ...
    var kn = /%20/g, Sn = /\[\]$/, En = /\r?\n/g, jn = /^(?:submit|button|image|reset|file)$/i, Nn = /^(?:input|select|textarea|keygen)/i;
    Z.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name&&!Z(this).is(":disabled") && Nn.test(this.nodeName)&&!jn.test(e) && (this.checked ||!kt.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
    ...
    e.attachEvent && e.attachEvent("onunload", function() {
        ...
        return G.cors || Ln&&!e.crossDomain ? {
            send: function(n, r) {
                ...
                t = function(e) {
                    return function() {
                        t && (delete An[a], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(qn[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                            text: o.responseText
    ...
    Z.ajaxSetup({
        ...
        var i, o, a, s = t.jsonp!==!1 && ($n.test(t.url) ? "url" : "string" == typeof t.data&&!(t.contentType || "").indexOf("application/x-www-form-urlencoded") && $n.test(t.data) && "data");
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace($n, "$1" + i) : t.jsonp!==!1 && (t.url += (fn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            return a || Z.error(i + " was not called"), a[0]
        }, t.dataTypes[0] = "json", o = e[i], e[i] = function() {
            a = arguments
        }, r.always(function() {
            e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Fn.push(i)), a && Z.isFunction(o) && o(a[0]), a = o = void 0
        }), "script") : void 0
    ...
    Z.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, a, s, u, l, c = Z.css(e, "position"), f = Z(e), d = {};
        ...
        offset: function(e) {
            ...
            if (o)
                return t = o.documentElement, Z.contains(t, r) ? (typeof r.getBoundingClientRect !== St && (i = r.getBoundingClientRect()), n = I(o), {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || On; e&&!Z.nodeName(e, "html") && "static" === Z.css(e, "position");)
                    e = e.offsetParent;
                return e || On
            })
        }
    ...
    var Rn = e.jQuery, _n = e.$;
    return Z.noConflict = function(t) {
        return e.$ === Z && (e.$ = _n), t && e.jQuery === Z && (e.jQuery = Rn), Z
    ...
    e.rails = n = {
        ...
        var i = e(this), o = i.data("method"), a = i.data("params"), s = r.metaKey || r.ctrlKey;
        if (!n.allowAction(i))
        ...
        var i, o, a = e(this), s = a.data("remote") !== t;
        if (!n.allowAction(a))
            return n.stopEverything(r);
        if (a.attr("novalidate") == t && (i = n.blankInputs(a, n.requiredInputSelector), i && n.fire(a, "ajax:aborted:required", [i])))
            return n.stopEverything(r);
        if (s) {
...
+ function(e) {
    ...
    jQuery(function() {
        return $('select[data-remote="true"]').bind("ajax:success", function(e, t) {
            var n, r, i, o, a, s;
            r = $(this), i = r.data("target"), n = i ? $(i) : r, n.closest(".hide").removeClass("hide"), n.find('option:not([value=""])').remove(), s = [];
            for (a in t)
                o = t[a], s.push($("<option value='" + a + "'>" + o + "</option>").appendTo(n));
            return s
        })
    })
}.call(this), function() {
    jQuery(function() {
        var e, t;
        return e = $("#send_users_sms_activation").click(function() {
            return $("#verify_code").focus()
        }).on({
            "ajax:beforeSend": function() {
                return $(this).is(".disabled")?!1 : $(this).button("loading")
            },
            "ajax:success": function(e, t) {
                return $(this).trigger("resend_counter", [t.limit])
            },
            "ajax:error": function(e, t) {
                return $(this).button("reset").removeClass("disabled"), alert(400 === t.status ? "\u8bf7\u7b49\u5f85\u5012\u8ba1\u65f6\u7ed3\u675f\u540e\u518d\u53d1\u9001" : "\u62b1\u6b49, \u77ed\u4fe1\u53d1\u9001\u5931\u8d25, \u8bf7\u7a0d\u540e\u91cd\u8bd5")
            },
            resend_counter: function(e, t) {
                var n, r, i;
                return n = $(this).addClass("disabled"), (r = function() {
                    return n.text(n.data("counter-text").replace("#seconds#", t--))
                })(), i = setInterval(function() {
                    return r(), 0 > t ? (clearInterval(i), n.button("reset").removeClass("disabled")) : void 0
                }, 1e3)
            }
        }), 0 !== e.length && (t = e.data("limit-time-left"), t > 0) ? e.trigger("resend_counter", [t]) : void 0
    })
}.call(this), function() {
    jQuery(function() {
        return function() {
            var e;
            return e = $("#wechat_login_container"), 0 !== e.length ? new WxLogin({
                id: "wechat_login_container",
                appid: e.data("appid"),
                scope: "snsapi_login",
                redirect_uri: e.data("redirect-uri"),
                state: e.data("state"),
                href: "https://passport.36kr.com/assets/wechat_qrconnect-b0db866334a6da201ad44c0860496560.css"
            }) : void 0
        }()
    })
}.call(this), function() {
    jQuery(function() {
        var e, t;
        if (0 !== $("body.new-user-session-classic").length)
            return $("#user_login").on("change, keyup", function() {
                return $(this).val().toString().match(/^\d{11}$/) ? $("#sms_verify_code_wrapper").show() : ($("#sms_verify_code_wrapper").hide(), $("#verify_code").val(""))
            }), e = $("#send_user_sign_in_token").click(function() {
                return $("#verify_code").focus()
            }).on({
                "ajax:before": function() {
                    return $(this).is(".disabled")?!1 : $(this).data("params", {
                ...
                "ajax:error": function(e, t) {
                    return $(this).button("reset").removeClass("disabled"), alert(400 === t.status ? "\u8bf7\u7b49\u5f85\u5012\u8ba1\u65f6\u7ed3\u675f\u540e\u518d\u53d1\u9001" : 422 === t.status ? "\u62b1\u6b49, \u60a8\u7684\u53f7\u7801\u5c1a\u672a\u572836\u6c2a\u6ce8\u518c, \u8bf7\u68c0\u67e5" : "\u62b1\u6b49, \u77ed\u4fe1\u53d1\u9001\u5931\u8d25, \u8bf7\u7a0d\u540e\u91cd\u8bd5")
                },
                resend_counter: function(e, t) {
                    var n, r, i;
                    return n = $(this).addClass("disabled"), (r = function() {
    ...
    jQuery(function() {
        return $("body").is(".portable-device") ? $('[data-toggle="popup"]').each(function() {
            return $(this).attr("href", $(this).data("src"))
        }) : $(document).on("click", '[data-toggle="popup"]', function() {
            var e, t, n, r, i;
            return e = $(this), r = e.data("src"), t = e.data("height"), i = e.data("width"), n = window.open(r, "_blank", "location=no, menubar=no, resizable=no, toolbar=no, top=200, left=400, height=" + t + ", width=" + i)
        })
    })
}.call(this);
